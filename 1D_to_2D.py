...
data_path="D:\\LenovoQMDownload\\PythonProject\\SVM_SMO\\data"
...
for item in os.listdir(images_path):
    ...
    print(*var)
    f = open('D:/LenovoQMDownload/PythonProject/SVM_SMO/1dto2d.txt', 'a')
    #f.write(str(var.tolist())+'\n')
    #f.write(str(','.join(var.tolist())))
...
# for i in var:
#     f = open('D:/LenovoQMDownload/PythonProject/SVM_SMO/1dto2d.txt', 'a')
#     f.write(str(delete_mid_var.tolist())+'\n')
#     f.close()
# for i in var:
#     f = open('D:/LenovoQMDownload/PythonProject/SVM_SMO/1dto2d.txt', 'a')
#     f.write(str(var.tolist())+'\n')
